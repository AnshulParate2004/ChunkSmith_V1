...
\begin{figure*}[htbp]
    ...
    \caption{ChunkSmith System Architecture. The API Key Pool is used exclusively during the Multimodal Semantic Enrichment phase to enable high-throughput asynchronous MLLM inference via round-robin key rotation. Generated structured semantic outputs are subsequently embedded and stored in the vector database for retrieval.}
