...
class Settings(BaseSettings):
    ...
    # Must be 2024-08-01-preview or later for json_schema / structured output
    AZURE_OPENAI_API_VERSION: str = "2024-12-01-preview"  # Azure OpenAI API version

    # Google Gemini Embedding settings (optional, used if GOOGLE_API_KEY is set)
    GOOGLE_EMBEDDING_MODEL: str = "models/gemini-embedding-001"
    GOOGLE_API_KEY: str = ""  # Prefer setting via environment variable GOOGLE_API_KEY
